(function() {
    // --- Configuration ---
    // Auto-detect widget URL relative to this script if not provided
    // This allows the widget to work out-of-the-box when hosted in the same folder
    const getScriptBaseUrl = () => {
        const script = document.currentScript || document.querySelector('script[src*="fin-widget.js"]');
    ...
    const DEFAULT_WIDGET_URL = getScriptBaseUrl() + 'widget.html';
